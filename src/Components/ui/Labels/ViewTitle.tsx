...
export default function ViewTitle({ title, showRefreshButton, setHandleRefetch }: ViewTitleProps) {
  return (
    <div className="flex items-center h-8 2xl:h-10 w-full px-10 gap-2 bg-gradient-to-b from-slate-800 to-[#081A51] border-b-2 border-[#2973B2] shadow-lg rounded-b-lg 2xl:px-12">
