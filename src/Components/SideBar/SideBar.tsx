...
import { MenuBase, MenuDev, MenuItem } from "./Menus";
import { getMergedMenu } from "./utils/mergeMenu";
...
import SidebarConfigButton from "./Components/SidebarConfigButton";
...
export default function SideBar({ open, setOpen }: SideBarProps) {
  ...
  const Menus = getMergedMenu(MenuBase, MenuDev, isDev);
  ...
  grid-cols-1"
    ...
    >
      ...
      <div className="px-2 pt-2">
        <ThumbtackButton isSidebarOpen={isSidebarOpen}
         isPinned={isPinned} hoveringArrow={hoveringArrow} setHoveringArrow={setHoveringArrow} onClick={handleThumbtack} />
