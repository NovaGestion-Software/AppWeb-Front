...
// Inputs
        //disabled
export const inputDisabledClass = "disabled:bg-[#BDBDBD] disabled:text-[#FFFFFF] ";
...
// Buttons
export const buttonsClass = "rounded-md bg-[#16457E] hover:bg-[#488FFD] disabled:bg-[#BDBDBD] disabled:text-white text-xxs v1440:h-8 v1536:h-8 v1536:px-6 v1536:text-sm";
