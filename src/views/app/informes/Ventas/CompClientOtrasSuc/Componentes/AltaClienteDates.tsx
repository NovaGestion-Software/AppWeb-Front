...
export default function AltaClienteDates({ className }: { className?: string }) {
  const { setFechasAlta, estaProcesado } = useCompClientOtrasSucStore();
  ...
  return (
    <Card className={` ${className}`}>
      <RangeDatesInput onClearData={() => {}} estaProcesado={estaProcesado} onFetchData={async (_dates) => {}} rangeDatePicker={propsRangePicker} />
    </Card>
  );
}
