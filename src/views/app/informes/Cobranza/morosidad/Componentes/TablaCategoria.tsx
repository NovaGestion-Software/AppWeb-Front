  ...
  const propsTabla = {
    ...
    objectStyles: {
      ...
      viewport1440: {
        ...
        widthContainer1440px: "20rem",
        heightContainer1440px: "25.5rem",
        addCellClass1440px: "max-height: 30px; font-size: .6rem;",
      },
      viewport1536: {
        heightContainer1536px: "24.6rem",
        widthContainer1536px: "22rem",
        addCellClass1536px: "max-height: 40px; font-size: .7rem; padding: 0px 5px 0px 5px;",
      },
      viewport1920: {
        widthContainer1920px: "28rem",
