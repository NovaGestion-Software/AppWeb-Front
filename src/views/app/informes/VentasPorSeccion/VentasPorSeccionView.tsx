    ...
    <div className="min-h-screen ">
      ...
      >
        ...
        <ListaFiltrosAplicados
          className=" v1440:mx-6
        col-start-7 col-span-5 row-start-3 "
          itemsDisponibles={sucursalesDisponiblesStr}
          itemsSeleccionados={sucursalesSeleccionadasStr}
        />
        <ActionButton onClick={() => setShowModal((prev) => !prev)} text="Condiciones de Pago"  color='indigo'
        addClassName=" h-12 w-36 text-xs col-start-7 col-span-2 row-start-5 v1440:mx-6" />
        <GraficoDeTorta
          className=" h-[19rem]  col-start-7 col-span-4 row-span-6 row-start-6 
          p-2 rounded-lg shadow-md shadow-gray-600 bg-white w-[29rem]  
          v1440:h-[22rem]  v1440:w-[32rem] v1440:mx-6 v1536:w-[36rem]"
        />
